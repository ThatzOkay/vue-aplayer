<template>
  ...
  <div class="landing">
    ...
    <div class="aplayer-wrap">
      <a-player :fixed="aplayer1.fixed" :lrcType="aplayer1.lrcType" :listMaxHeight="aplayer1.listMaxHeight" :preload="aplayer1.preload" :audio="aplayer1.audio" :listFolded="aplayer1.listFolded"  />
    </div>
...
import './App.scss';
import '@moefe/vue-aplayer/assets/style/aplayer.scss'
import type { Options as APlayerOptions } from 'types/options';
import type { Audio as APlayerAudio } from 'types';
...
onMounted(async () => {
  ...
  console.log("music", (music as any).default)
